...
public class V extends javax.swing.JFrame {
  ...
  //select name from emp where name like 'ravi%'  
    ...
    private void initComponents() {
        ...
        TBTaula.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TBTaulaMouseClicked(evt);
            }
        });
        TBTaula.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TBTaulaKeyTyped(evt);
            }
        });
    ...
    private void TBTaulaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TBTaulaMouseClicked
                int fila=this.TBTaula.getSelectedRow();
            int columna =this.TBTaula.getSelectedColumn();
            System.out.println(this.TBTaula.getValueAt(fila,columna)); 
            this.LB.setText((String) this.TBTaula.getValueAt(fila,columna));
         
       
    }//GEN-LAST:event_TBTaulaMouseClicked

    private void TBTaulaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBTaulaKeyTyped
         int tecla= evt.getKeyChar();
         this.TFE.setText("");
        if(tecla==10)// si apretar ENTER
        {
    ...
    }//GEN-LAST:event_TBTaulaKeyTyped
